    ...
    function getVariables()
    {
        $variables = array(
            /*T*/'Plugin Name'/*/T*/ => array (
                                ...
                                'value'         =>/*T*/'NetEarth One'/*/T*/
                               ),
            /*T*/'Reseller ID'/*/T*/ => array(
                                'type'          =>'text',
                                'description'   =>/*T*/'Enter your NetEarth One Reseller ID.  This can be found in your NetEarth One account by going to Settings -> Personal Information -> Primary Profile.  The first field indicates your Reseller ID.'/*/T*/,
                                'value'         =>''
                               ),
            /*T*/'Password'/*/T*/ => array(
                                'type'          =>'password',
                                'description'   =>/*T*/'Enter the password for your NetEarth One reseller account.'/*/T*/,
                                'value'         =>''
                               ),
            /*T*/'API Key'/*/T*/ => array(
                                'type'          =>'text',
                                'description'   =>/*T*/'Enter your API Key for your NetEarth One reseller account.  You should use this instead of your password, however you still may use your password instead.'/*/T*/,
                                'value'         =>''
                               ),
            /*T*/'Use testing server'/*/T*/ => array(
                                'type'          =>'yesno',
                                'description'   =>/*T*/'Select Yes if you wish to use the NetEarth One testing environment, so that transactions are not actually made.<br><br><b>Note: </b>You will first need to register for a demo account at<br>http://cp.onlyfordemo.net/servlet/ResellerSignupServlet?&validatenow=false.'/*/T*/,
                                'value'         =>0
                               ),
